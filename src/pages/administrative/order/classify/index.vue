 ...
 * @LastEditTime: 2023-04-06 17:02:21
 * @LastEditors: max
 * @Description: 
 * @FilePath: /up-admin/src/pages/administrative/order/classify/index.vue
-->
<template>
    <div>
  ...
  <script>
  import { getGoodsClassify, setGoodsClassify } from "@/services/ors.js";
  import { renderStripe } from "@/utils/stripe.js";
  import getTableScroll from "@/utils/setTableHeight";
  import { splitData } from "@/utils/util.js";
  import { PublicVar } from "@/mixins/publicVar.js";
  import useForm from "./classifyForm.vue";
  const columns = [
    {
      title: "序号",
    ...
    methods: {
      ...
      allDel() {
        ...
        self.$confirm({
          title: "确定要删除选中内容",
          onOk() {
            setGoodsClassify(self.selectedRowKeys, "delete").then((res) => {
              if (res.data.success) {
      ...
      onDelete(id) {
        let params = [id];
        setGoodsClassify(params, "delete").then((res) => {
          if (res.data.success) {
