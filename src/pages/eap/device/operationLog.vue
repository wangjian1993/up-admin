 ...
 * @LastEditTime: 2022-07-28 09:43:32
 * @LastEditors: max
 * @Description: 
...
<script>
import { getOperationAction, setOperationAction, getDeviceAction, getPlantList, getWorkshopAction, getPlcAction } from "@/services/eap.js";
import { getParamData } from "@/services/admin.js";
import { renderStripe } from "@/utils/stripe.js";
import getTableScroll from "@/utils/setTableHeight";
import { splitData } from "@/utils/util.js";
import { PublicVar } from "@/mixins/publicVar.js";
import { columns } from "./data/operationLog";
...
export default {
  ...
  methods: {
    ...
    getListAll() {
      ...
      getOperationAction(params, "log/getall").then((res) => {
        if (res.data.success) {
    ...
    onDelete(item) {
      let params = [];
      params.push(item.VarValueLogId);
