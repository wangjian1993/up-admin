 ...
 * @LastEditTime: 2022-07-28 09:45:23
 * @LastEditors: max
 * @Description: 
    ...
    <a-spin tip="导出中..." :spinning="isExportLod">
      <a-card class="card" :bordered="false" :bodyStyle="{ padding: '5px' }">
        ...
        <a-table
          ...
          :rowKey="(dataSource) => dataSource.VarId"
          bordered
        >
      ...
      <plcParamsForm v-if="isForm" :isEdit="isEdit" :editData="editData" :paramsItem="paramsItem" @closeModal="closeModal" @success="getListAll" />
...
<script>
import { getPlcParamsAction, setPlcParamsAction } from "@/services/eap.js";
import { getParamData } from "@/services/admin.js";
import { renderStripe } from "@/utils/stripe.js";
import getTableScroll from "@/utils/setTableHeight";
import { splitData } from "@/utils/util.js";
import { PublicVar } from "@/mixins/publicVar.js";
import { columns } from "./data/plcParams";
import plcParamsForm from "./components/plcParamsForm.vue";
import ExportExcel from "@/utils/ExportExcelJS";
import ImportPlcParamsExcel from "./components/ImportPlcParamsExcel.vue";
export default {
  mixins: [PublicVar],
  components: { plcParamsForm, ImportPlcParamsExcel },
  data() {
    return {
      scrollY: "",
      advanced: true,
  ...
  methods: {
    ...
    allDel() {
      ...
      self.$confirm({
        title: "确定要删除选中内容",
        onOk() {
          setPlcParamsAction(self.selectedRowKeys, "delete").then((res) => {
            if (res.data.success) {
