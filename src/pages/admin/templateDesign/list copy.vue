 ...
 * @LastEditTime: 2022-08-18 09:24:36
 * @LastEditors: max
 * @Description: 
            ...
            <a-row>
              <a-col :md="6" :sm="24">
                <a-form-item label="模板名称/编码" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18, offset: 1 }">
                  <a-input style="width: 200px" placeholder="请输入模板名称/编码" v-decorator="['supplier']" />
                </a-form-item>
              </a-col>
              <a-col :md="6" :sm="24">
                <a-form-item label="模板类型" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18, offset: 1 }">
                  <a-input style="width: 200px" placeholder="请输入模板类型" v-decorator="['orderno']" />
                </a-form-item>
              </a-col>
              <a-col :md="6" :sm="24">
                <a-form-item label="机构" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18, offset: 1 }">
...
<script>
import { getTemplateAction } from "@/services/admin.js";
