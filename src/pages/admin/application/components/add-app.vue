			...
			<a-tabs default-active-key="1">
				<a-tab-pane key="1" tab="基本信息">
					<a-form-model ref="ruleForm" :model="form" :rules="rules" :label-col="labelCol" :wrapper-col="wrapperCol">
						<a-row>
							<a-col :span="12">
								<a-form-model-item ref="EnterCode" label="logo">
									<a-upload
										name="avatar"
				...
				<a-tab-pane key="2" tab="应用首页">
					<a-form-model ref="ruleForm" :model="form" :rules="rules" :label-col="labelCol" :wrapper-col="wrapperCol">
						<a-row>
							...
							<a-col :span="24">
								<a-form-model-item ref="MouduleUrl" label="组件路径"><a-input v-model="form.MouduleUrl" placeholder="组件路径" /></a-form-model-item>
							</a-col>
							<a-col :span="24">
								<a-form-model-item ref="MouduleParam" label="组件参数"><a-input v-model="form.MouduleParam" placeholder="组件参数" /></a-form-model-item>
							</a-col>
							<a-col :span="24">
