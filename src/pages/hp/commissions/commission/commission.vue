...
<template>
  <div>
    <a-spin tip="导出中..." :spinning="isExportLod">
      ...
      <a-table :columns="columns" :data-source="dataSource" size="small" :scroll="{ y: scrollY ,x:2500}" :loading="loading" :pagination="pagination" @change="handleTableChange" :rowKey="(dataSource) => dataSource.Id" bordered>
...
<script>
import { getCommissionList, getSalesmanList } from "@/services/hp.js";
