<!--
 * @Author: max
 * @Date: 2022-03-25 17:13:10
 * @LastEditTime: 2022-03-28 14:07:15
 * @LastEditors: max
 * @Description: 
 * @FilePath: /up-admin/src/pages/hp/commissions/Intermediary/index.vue
-->
<template>
  <a-card class="card" :bordered="false" :bodyStyle="{ padding: '5px' }">
    ...
    <Intermediary :rolesign="rolesign" :columns="columns" ref="discountBox" />
  </a-card>
</template>
<script>
import Intermediary from "./Intermediary.vue";
