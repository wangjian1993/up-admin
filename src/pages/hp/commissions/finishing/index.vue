<!--
 * @Author: max
 * @Date: 2022-03-25 17:18:35
 * @LastEditTime: 2022-03-29 14:18:15
 * @LastEditors: max
 * @Description: 
 * @FilePath: /up-admin/src/pages/hp/commissions/finishing/index.vue
-->
<template>
  <a-card class="card" :bordered="false" :bodyStyle="{ padding: '5px' }">
    ...
    <finishing :rolesign="rolesign" :columns="columns" ref="discountBox" />
  </a-card>
</template>
<script>
import finishing from "./finishing.vue";
