 ...
 * @LastEditTime: 2022-03-28 15:44:25
 * @LastEditors: max
 * @Description: 
 * @FilePath: /up-admin/src/pages/hp/commissions/monthlyTask/index.vue
-->
<template>
  <a-card class="card" :bordered="false" :bodyStyle="{ padding: '5px' }">
    ...
    <monthlyTask :rolesign="rolesign" :columns="columns" ref="discountBox" />
  </a-card>
</template>
<script>
