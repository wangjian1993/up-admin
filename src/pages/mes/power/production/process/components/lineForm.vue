 ...
 * @LastEditTime: 2022-10-13 14:28:44
 * @LastEditors: max
 * @Description: 
 * @FilePath: /up-admin/src/pages/mes/power/production/process/components/lineForm.vue
-->
<template>
  <div>
...
<script>
import {setProcessLine ,getPowerPlant ,getProcess } from "@/services/mes.js";
export default {
