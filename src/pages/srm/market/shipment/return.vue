 ...
 * @LastEditTime: 2022-08-25 09:31:47
 * @LastEditors: max
 * @Description: 
 * @FilePath: /up-admin/src/pages/srm/market/shipment/return.vue
-->
<template>
  <div>
        ...
        <a-form layout="horizontal" :form="searchForm">
          ...
          <div :class="advanced ? null : 'fold'" v-if="advanced">
            <a-row>
              ...
              <a-col :md="6" :sm="24">
                <a-form-item label="退货单号" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18, offset: 1 }">
                  <a-input style="width: 200px" placeholder="请输入退货单号" v-decorator="['orderno']" />
                </a-form-item>
              </a-col>
              <a-col :md="6" :sm="24">
              ...
              <a-col :md="6" :sm="24">
                <a-form-item label="退货日期" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18, offset: 1 }">
                  <a-range-picker style="width: 300px" v-decorator="['range-time-picker1']" />
                </a-form-item>
              </a-col>
              <a-col :md="6" :sm="24">
                <a-form-item label="是否退货" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18, offset: 1 }">
                  <a-select v-decorator="['deliverystatus']" placeholder="请选择是否退货" style="width: 200px">
...
import { columns } from "./data/return";
    ...
    search() {
      this.searchForm.validateFields((err, values) => {
        if (!err) {
          ...
          getClientReturn(params, "get").then((res) => {
            if (res.data.success) {
