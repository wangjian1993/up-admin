 ...
 * @LastEditTime: 2022-08-16 13:58:54
 * @LastEditors: max
 * @Description: 
 * @FilePath: /up-admin/src/pages/srm/market/order/orderDetail.vue
-->
<template>
  <div>
            ...
            <a-row>
              ...
              <a-col :md="6" :sm="24">
                <a-form-item label="客户单号" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18, offset: 1 }">
                  <a-input style="width: 200px" placeholder="请输入客户单号" v-decorator="['orderno']" />
                </a-form-item>
              </a-col>
              <a-col :md="6" :sm="24">
...
import { orderType } from "../../data/params";
export default {
  mixins: [PublicVar],
  data() {
    return {
    ...
    search() {
      this.searchForm.validateFields((err, values) => {
        if (!err) {
          ...
          getClientOrder(parmas, "getdetail").then((res) => {
            if (res.data.success) {
