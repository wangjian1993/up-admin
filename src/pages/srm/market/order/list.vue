            ...
            <a-row>
              <a-col :md="6" :sm="24">
                <a-form-item label="客户" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18, offset: 1 }">
                  <a-input style="width: 200px" placeholder="请输入客户" v-decorator="['supplier']" />
                </a-form-item>
              </a-col>
              <a-col :md="6" :sm="24">
              ...
              <a-col :md="6" :sm="24">
                <a-form-item label="产品" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18, offset: 1 }">
                  <a-input style="width: 200px" placeholder="请输入产品" v-decorator="['product']" />
                </a-form-item>
              </a-col>
              <a-col :md="6" :sm="24">
                <a-form-item label="采购类型" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18, offset: 1 }">
                  <a-select v-decorator="['purchasestatus']" placeholder="请选择订单状态" style="width: 200px">
                    <a-select-option :value="item" v-for="(item, index) in purchaseType" :key="index">{{ item }}</a-select-option>
                  </a-select>
                </a-form-item>
              </a-col>
              <a-col :md="6" :sm="24">
              ...
              <a-col :md="6" :sm="24">
                <a-form-item label="采购日期" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18, offset: 1 }">
                  <a-range-picker style="width: 300px" v-decorator="['range-time-picker1']" />
                </a-form-item>
              </a-col>
              <a-col :md="6" :sm="24">
                <a-form-item label="交货日期" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18, offset: 1 }">
              ...
              <a-col :md="6" :sm="24">
                <a-form-item label="订单状态" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18, offset: 1 }">
                  <a-select v-decorator="['receiptstatus']" placeholder="请选择订单状态" style="width: 200px">
                    <a-select-option :value="item" v-for="(item, index) in orderType" :key="index">{{ item }}</a-select-option>
                  </a-select>
                </a-form-item>
              </a-col>
              <a-col :md="6" :sm="24">
                <a-form-item label="送货状态" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18, offset: 1 }">
                  <a-select v-decorator="['purchasetype']" placeholder="请选择收货状态" style="width: 200px">
                    <a-select-option :value="item" v-for="(item, index) in deliveryStatus" :key="index">{{ item }}</a-select-option>
                  </a-select>
                </a-form-item>
              </a-col>
              <a-col :md="6" :sm="24">
                <a-form-item label="签章状态" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18, offset: 1 }">
                  <a-select v-decorator="['purchasetype']" placeholder="请选择采购类性" style="width: 200px">
                    <a-select-option :value="item" v-for="(item, index) in signatureStatus" :key="index">{{ item }}</a-select-option>
                  </a-select>
                </a-form-item>
              </a-col>
            </a-row>
...
<script>
import { getClientOrder } from "@/services/srm.js";
...
import { purchaseType, orderType, deliveryStatus, signatureStatus } from "../../data/params";
export default {
  components: { Detail },
  mixins: [PublicVar],
  data() {
