<template>
  <div>
    <a-modal title="添加资质文件" v-if="visible" :visible="visible" destoryOnClose @ok="handleOk" @cancel="handleCancel">
      <a-form-model ref="ruleForm" :model="form" :rules="rules" :label-col="labelCol" :wrapper-col="wrapperCol">
        <a-form-model-item has-feedback label="ERP分类">
          <span>{{ editData.ClassName }}</span>
        </a-form-model-item>
...
<script>
import { setQuaList, updateFile, deleteFile } from "@/services/srm.js";
    ...
    handleOk() {
      this.$refs.ruleForm.validate((valid) => {
        if (valid) {
          ...
          this.form.classcode = this.editData.ClassCode;
          this.form.classname = this.editData.ClassName;
          setQuaList(this.form, "add").then((res) => {
            if (res.data.success) {
