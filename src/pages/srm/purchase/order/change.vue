 ...
 * @LastEditTime: 2022-08-11 17:54:16
 * @LastEditors: max
 * @Description: 
 * @FilePath: /up-admin/src/pages/srm/purchase/order/change.vue
-->
<template>
  <div>
...
<script>
import { getPurchaseChange } from "@/services/srm.js";
import { renderStripe } from "@/utils/stripe.js";
import getTableScroll from "@/utils/setTableHeight";
import { splitData } from "@/utils/util.js";
import { PublicVar } from "@/mixins/publicVar.js";
import { columns } from "./data/change";
    ...
    search() {
      this.searchForm.validateFields((err, values) => {
        if (!err) {
          ...
          getPurchaseChange(parmas, "get").then((res) => {
            if (res.data.success) {
