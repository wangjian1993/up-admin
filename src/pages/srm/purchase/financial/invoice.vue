 ...
 * @LastEditTime: 2022-09-07 15:24:03
 * @LastEditors: max
 * @Description: 
 * @FilePath: /up-admin/src/pages/srm/purchase/financial/invoice.vue
-->
<template>
    <div>
  ...
  <script>
  import { getInvoice } from "@/services/srm.js";
  import { renderStripe } from "@/utils/stripe.js";
  import getTableScroll from "@/utils/setTableHeight";
  import { splitData } from "@/utils/util.js";
  import { PublicVar } from "@/mixins/publicVar.js";
  import { columns } from "./data/invoice";
      ...
      search() {
        this.searchForm.validateFields((err, values) => {
          if (!err) {
            ...
            getInvoice(params, "get").then((res) => {
              if (res.data.success) {
