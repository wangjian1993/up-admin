 ...
 * @LastEditTime: 2022-09-01 09:26:53
 * @LastEditors: max
 * @Description: 
 * @FilePath: /up-admin/src/pages/srm/domain/index.vue
-->
<template>
  <div>
    <a-spin tip="导出中..." :spinning="isExportLod">
      ...
      <listForm v-if="isForm" :isEdit="isEdit" :editData="editData" @closeModal="closeModal" @success="getListAll" />
    </a-spin>
  </div>
</template>
