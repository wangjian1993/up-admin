<!--
 * @Author: max
 * @Date: 2022-04-06 08:45:19
 * @LastEditTime: 2022-04-06 08:54:27
 * @LastEditors: max
 * @Description: 
 * @FilePath: /up-admin/src/pages/esop/record/docs.vue
-->
<template>
  <div>
    <a-modal v-model="visible" title="查看附件" @cancel="close" :footer="null" centered width="70%">
      <div>
...
export default {
  ...
  methods: {
    ...
    getDocsFile() {
      let parmas = {
        recordid: this.documentItem.DocumentId,
