 ...
 * @LastEditTime: 2022-02-09 18:19:23
 * @LastEditors: max
 * @Description: 
      ...
      <a-card class="card" :bordered="false" :bodyStyle="{ padding: '5px' }">
        ...
        >
          <template slot="ShipmentQtyNow" slot-scope="text, record">
            <a-input-number :min="0" :max="record.ShipmentQtyOrder" :value="text" @change="(e) => handleChange(e, record.ItemCode, 'ShipmentQtyNow')" />
          </template>
        </a-table>
      </a-card>
    </a-drawer>
...
export default {
  ...
  methods: {
    ...
    GoodsExamineTimeChange(e) {
      console.log(e);
    },
    GoodsPickTimeChange(e) {
      console.log(e);
    },
    save() {
      ...
      //验货时间
      console.log("哈哈哈哈", typeof this.saveParmas.GoodsExamineTime == "Moment");
      if (this.saveParmas.GoodsExamineTime != "" && this.saveParmas.GoodsExamineTime == Object) {
        this.saveParmas.GoodsExamineTime = this.saveParmas.GoodsExamineTime.format("YYYY-MM-DD");
      }
      //提货时间
      if (this.saveParmas.GoodsExamineTime == Object) {
