    ...
    <a-card class="card" :bordered="false" :bodyStyle="{ padding: '5px' }">
      <a-spin tip="导出中..." :spinning="isExportLod">
        ...
        <div class="operator">
          ...
          <a-button v-if="hasPerm('shipment')" icon="edit" type="primary" :disabled="!hasSelected" :loading="loading" @click="onDelete()" style="margin-left: 8px">确认出货</a-button>
          <a-button v-else icon="edit" type="primary" disabled :loading="loading" @click="onDelete" style="margin-left: 8px">确认出货</a-button>
