 ...
 * @LastEditTime: 2022-07-28 09:23:13
 * @LastEditors: max
 * @Description: 
  ...
  <div>
    <a-form layout="horizontal" :form="searchForm">
      <div :class="advanced ? null : 'fold'">
        <a-row>
          <a-col :md="6" :sm="24">
            <a-form-item label="生产工厂1" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18, offset: 1 }">
        ...
        <a-row v-if="advanced">
          ...
          <a-col :md="6" :sm="24">
            <a-form-item label="品号" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18, offset: 1 }">
              <a-input style="width: 200px" placeholder="请输入品号号" v-decorator="['mitemcode']" />
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="24">
...
const columns = [
  ...
  {
    title: "业务订单号行号",
    dataIndex: "SalesLineItem",
    scopedSlots: { customRender: "SalesLineItem" },
    align: "center",
  },
  {
    title: "业务订单数量",
  ...
  {
    title: "内部订单行号",
    dataIndex: "InnerLineItem",
    scopedSlots: { customRender: "InnerLineItem" },
    align: "center",
  },
  {
    title: "内部订单数量",
    dataIndex: "InnerOrderQty",
    scopedSlots: { customRender: "InnerOrderQty" },
    align: "center",
  },
  {
    title: "品号",
