    ...
    <a-form layout="horizontal">
      <div>
        <a-row>
          ...
          <a-col :md="8" :sm="24">
            <a-form-item label="计划生成日期" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18, offset: 1 }">
        ...
        <a-row>
          <a-col :md="8" :sm="24">
            <a-form-item label="人数" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18, offset: 1 }">
               <a-input-number style="width: 100%" placeholder="请输入人数" />
            </a-form-item>
          </a-col>
          <a-col :md="8" :sm="24">
            <a-form-item label="生成车间" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18, offset: 1 }">
              <a-select placeholder="请选择生成车间">
                <a-select-option value="1">关闭</a-select-option>
                <a-select-option value="2">运行中</a-select-option>
              </a-select>
            </a-form-item>
        ...
        <a-row>
          <a-col :md="8" :sm="24">
            <a-form-item label="导入excel" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18, offset: 1 }">
              <div style="display:flex;">
                <a-upload name="file" :multiple="true" :headers="headers" @change="handleChange">
                  <a-button> <a-icon type="upload" />导入物料需求表</a-button>
                </a-upload>
                <a class="down-excel"><span>EXCEL模板</span></a>
              </div>
            </a-form-item>
          </a-col>
        </a-row>
