 ...
 * @LastEditTime: 2022-04-02 14:10:14
 * @LastEditors: max
 * @Description: 
...
<template>
  <div>
    <a-modal v-model="visible" title="导入物料需求计划" @cancel="close" :maskClosable="false" @ok="handleOk" centered :width="800">
...
export default {
  ...
  methods: {
    ...
    // 读取文件
    readFile(file) {
      let tableHead = ["材料品号", "材料品名", "材料规格", "交货数量", "交货日期", "是否急料"];
      let tableHead2 = [];
