        ...
        <a-form layout="horizontal" :form="searchForm">
          <div :class="advanced ? null : 'fold'">
            <a-row>
              ...
              <a-col :md="6" :sm="24">
                <a-form-item label="基准价格1" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18, offset: 1 }">
                  <a-input-number
                    :min="0"
                    style="width: 200px"
                    allowClear
              ...
              <a-col :md="6" :sm="24">
                <a-form-item label="基准价格2" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18, offset: 1 }">
                  <a-input-number
                    :min="0"
                    style="width: 200px"
                    allowClear
...
export default {
  ...
  methods: {
    ...
    update() {
      ...
      getMaterialsPrice(parmas).then((res) => {
        if (res.data.success) {
