 ...
 * @LastEditTime: 2023-05-24 14:28:31
 * @LastEditors: max
 * @Description: 
    ...
    <a-spin tip="导出中..." :spinning="isExportLod">
      <a-card class="card" :bordered="false" :bodyStyle="{ padding: '5px' }">
        <a-form layout="horizontal" :form="searchForm">
          <div :class="advanced ? null : 'fold'">
            <a-row>
              ...
              <a-col :md="6" :sm="24">
                <a-form-item label="机型" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18, offset: 1 }">
                  <a-input style="width: 200px" allowClear placeholder="请输入机型" v-decorator="['type']" />
                </a-form-item>
              </a-col>
              <a-col :md="6" :sm="24">
                <a-form-item label="PCB料号" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18, offset: 1 }">
                  <a-input style="width: 200px" allowClear placeholder="请输入PCB料号" v-decorator="['pcbno']" />
                </a-form-item>
              </a-col>
              <a-col :md="6" :sm="24">
                <a-form-item label="同源编号" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18, offset: 1 }">
                  <a-input style="width: 200px" allowClear placeholder="请输入同源编号" v-decorator="['other']" />
                </a-form-item>
              </a-col>
              <a-col :md="6" :sm="24">
                <a-form-item label="类型" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18, offset: 1 }">
                  <a-input style="width: 200px" allowClear placeholder="请输入类型" v-decorator="['type2']" />
                </a-form-item>
              </a-col>
              <a-col :md="6" :sm="24">
                <a-form-item label="PCB型号" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18, offset: 1 }">
                  <a-input style="width: 200px" allowClear placeholder="请输入PCB型号" v-decorator="['pcbtypeno']" />
                </a-form-item>
              </a-col>
              <a-col :md="6" :sm="24">
                <a-form-item label="货架" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18, offset: 1 }">
                  <a-input style="width: 200px" allowClear placeholder="请输入货架" v-decorator="['storagerack']" />
                </a-form-item>
              </a-col>
              <a-col :md="6" :sm="24">
                <a-form-item label="位置" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18, offset: 1 }">
                  <a-input style="width: 200px" allowClear placeholder="请输入位置" v-decorator="['position']" />
                </a-form-item>
              </a-col>
              <a-col :md="6" :sm="24">
        ...
        <a-table
          ...
          :rowKey="(dataSource) => dataSource.DetailId"
          bordered
        >
      ...
      this.searchForm.validateFields((err, values) => {
        if (!err) {
          ...
          let params = {
            ...
            other: values.other,
            type2: values.type2,
            pcbtypeno: values.pcbtypeno,
            storagerack: values.storagerack,
            position: values.position,
            status: values.status,
          };
          getTestJig(params, "get").then((res) => {
            if (res.data.success) {
