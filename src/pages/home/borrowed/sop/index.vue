 ...
 * @LastEditTime: 2023-04-25 15:36:41
 * @LastEditors: max
 * @Description: 
...
<template>
          ...
          >
            ...
            <template slot="action" slot-scope="text, record">
              <div>
                ...
                <a style="margin-right: 8px" @click="borrowed(record)" v-if="record.Status == '已借出' || record.Status == '未使用'">
                  <a-icon type="export" />
                  借出
                </a>
                <a style="margin-right: 8px" @click="borrowed(record)"  v-if="record.Status == '已归还' || record.Status == '钢网异常'">
                  <a-icon type="export" />
                  归还
                </a>
              </div>
  ...
  <script>
  import { getBorrowedSop, setBorrowedSop } from "@/services/web.js";
  ...
  export default {
    ...
    methods: {
      ...
      allDel() {
        ...
        self.$confirm({
          ...
          onOk() {
            ...
            setBorrowedSop(params, "deletelpsm").then((res) => {
              if (res.data.success) {
      ...
      exportExcel() {
        ...
        getBorrowedSop(params, "getlpsmlist").then((res) => {
          if (res.data.success) {
