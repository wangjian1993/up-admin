 ...
 * @LastEditors: max
 * @Description: 
 * @FilePath: /up-admin/src/pages/home/borrowed/sop/ImportExcel.vue
-->

<template>
  <div>
    <a-modal v-model="visible" title="导入电源部SOP" @cancel="close" @ok="handleOk" :maskClosable="false" centered :width="400">
  ...
  methods: {
    ...
    handleOk() {
      ...
      getBase64(this.file, (baseUrl) => {
        ...
        setBorrowedSop(params, "import").then((res) => {
          if (res.data.success) {
