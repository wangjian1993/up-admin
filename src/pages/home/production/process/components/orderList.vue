 ...
 * @LastEditTime: 2023-04-10 16:52:03
 * @LastEditors: max
 * @Description: 
 * @FilePath: /up-admin/src/pages/home/production/process/components/orderList.vue
-->
<template>
  <div>
...
<script>
import { getStartWorkApi } from "@/services/web.js";
export default {
  props: ["processData", "type",'defaultLine'],
  data() {
    return {
      orderData: [],
      visible: true,
  ...
  methods: {
    ...
    getDocsList() {
      ...
      let params = {
        ...
        process: this.processData.PROCESS_CODE,
      };
      let url = "process/" + this.type + "/getmos";
      getStartWorkApi(params, url).then((res) => {
