 ...
 * @LastEditTime: 2021-12-23 13:40:15
 * @LastEditors: max
 * @Description: 
 * @FilePath: /up-admin/src/pages/home/production/rework/components/orderSelect.vue
-->
<template>
  <div>
      ...
      <div>
        <a-card class="card" :bordered="false" :bodyStyle="{ padding: '5px' }">
          ...
          >
            ...
            <template slot="reworkQty" slot-scope="text, record">
              <a-input-number v-model="record.reworkQty" size="small" :min="0" :max="record.PlanQty"/>
            </template>
          </a-table>
        </a-card>
      </div>
  ...
  methods: {
    ...
    handleOk() {
      ...
      this.selectedRowKeys.forEach((item) => {
        list.push(this.orderSelectList[item]);
      });
