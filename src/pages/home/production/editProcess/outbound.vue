 ...
 * @LastEditTime: 2023-04-25 14:56:54
 * @LastEditors: max
 * @Description: 
 * @FilePath: /up-admin/src/pages/home/production/editProcess/outbound.vue
-->
<template>
    <div>
  ...
  <script>
  import { getEditOutbound, setEditOutbound, getProcessLine } from "@/services/web.js";
      ...
      search() {
        this.searchForm.validateFields((err, values) => {
          if (!err) {
            ...
            getEditOutbound(params, "getall").then((res) => {
              if (res.data.success) {
