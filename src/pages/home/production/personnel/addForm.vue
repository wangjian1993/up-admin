 ...
 * @LastEditTime: 2021-11-29 16:27:12
 * @LastEditors: max
 * @Description: 
    ...
    <a-modal v-model="visible" title="添加人员配置" @cancel="close" @ok="handleOk" centered :width="600">
      <div>
        <a-form-model ref="ruleForm" :model="form" :rules="rules" :label-col="labelCol" :wrapper-col="wrapperCol">
          ...
          <a-form-model-item ref="WorkshopId" has-feedback label="生产工厂" prop="WorkshopId">
            <a-select v-model="form.WorkshopId" placeholder="请选择生产工厂" @change="workshopChange">
