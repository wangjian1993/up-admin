 ...
 * @LastEditTime: 2021-11-17 17:58:48
 * @LastEditors: max
 * @Description: 导入生产日计划
 * @FilePath: /up-admin/src/pages/home/production/dailyPlan/print.vue
-->
<template>
  <a-modal v-model="visible" title="打印生产投料单" v-if="visible" @cancel="close" :footer="null" centered width="50%">
    ...
    <div class="content" id="printTest">
      <div class="content-top">
        ...
        <div class="head-qr"><vue-qr :text="printData.QRCode" :size="300"></vue-qr></div>
      </div>
