 ...
 * @LastEditTime: 2022-07-29 09:37:04
 * @LastEditors: max
 * @Description: 
 * @FilePath: /up-admin/src/pages/home/production/preProcess/index.vue
-->
<template>
  <a-card class="card" :bordered="false" :bodyStyle="{ padding: '5px' }">
    ...
    <a-tabs type="card" default-active-key="1" v-model="tabKey" @change="callback">
      <a-tab-pane key="1" tab="前加工开工" v-if="hasPerm('process_tab1')"></a-tab-pane>
      <a-tab-pane key="2" tab="前加工进站报工" v-if="hasPerm('process_tab2')"> </a-tab-pane>
      <a-tab-pane key="3" tab="前加工出站报工" v-if="hasPerm('process_tab3')"></a-tab-pane>
      <a-tab-pane key="4" tab="前加工报工查询" v-if="hasPerm('process_tab4')"></a-tab-pane>
    </a-tabs>
