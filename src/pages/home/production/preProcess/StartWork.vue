 ...
 * @LastEditTime: 2023-05-08 10:36:33
 * @LastEditors: max
 * @Description: 
 * @FilePath: /up-admin/src/pages/home/production/preProcess/StartWork.vue
-->
<template>
  <!-- 搜索 -->
...
<script>
import { setPreStartWorkApi, getPrintInfo } from "@/services/web.js";
...
export default {
  ...
  methods: {
    ...
    startWork() {
      ...
      setPreStartWorkApi(params, "submit").then((res) => {
        res.data.message.time = getTimeData();
        if (res.data.success) {
          res.data.message.IsSuccess = res.data.data.IsSuccess;
          if (res.data.data.IsSuccess) {
