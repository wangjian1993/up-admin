 ...
 * @LastEditTime: 2022-07-29 11:07:09
 * @LastEditors: max
 * @Description: 
 * @FilePath: /up-admin/src/pages/home/production/preProcess/identification.vue
-->
<template>
  <div>
...
import { setPrePrintInfo } from "@/services/web.js";
...
export default {
  ...
  methods: {
    ...
    getPrintList() {
      ...
      setPrePrintInfo(parmas, "getmitemprint").then((res) => {
        if (res.data.success) {
