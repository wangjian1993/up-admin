...
<script>
import { setSampleStartWorkApi } from "@/services/web.js";
...
export default {
  ...
  methods: {
    ...
    getWorkInfo() {
      setSampleStartWorkApi("", "loaduserline").then((res) => {
        if (res.data.success) {
    ...
    scanCode(e) {
      ...
      setSampleStartWorkApi(parmas, "scan").then((res) => {
        res.data.message.time = getTimeData();
        if (res.data.success) {
          res.data.message.IsSuccess = res.data.data.IsSuccess;
          this.receiveQty = 0;
    ...
    getHistoryList() {
      ...
      this.orderList = [];
      setSampleStartWorkApi(parmas, "gethisreports").then((res) => {
        res.data.message.time = getTimeData();
        if (res.data.success) {
          res.data.message.IsSuccess = res.data.data.IsSuccess;
          if (res.data.data.IsSuccess) {
    ...
    startWork() {
      ...
      setSampleStartWorkApi(parmas, url).then((res) => {
        res.data.message.time = getTimeData();
        if (res.data.success) {
          res.data.message.IsSuccess = res.data.data.IsSuccess;
          if (res.data.data.IsSuccess) {
    ...
    listUpdate(item) {
      ...
      setSampleStartWorkApi(parmas, "update").then((res) => {
        res.data.message.time = getTimeData();
        if (res.data.data.IsSuccess) {
          res.data.message.content = res.data.data.Msg;
          this.listData.unshift(res.data.message);
