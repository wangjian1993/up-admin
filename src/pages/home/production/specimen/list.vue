...
<script>
import { getWorkshopList, getLineList, getSampleStartWorkApi, getDailyPlanAction } from "@/services/web.js";
...
export default {
  ...
  methods: {
    ...
    getListAll() {
      ...
      getSampleStartWorkApi(params, "v2/getall").then((res) => {
        if (res.data.success) {
    ...
    exportExcel() {
      ...
      getSampleStartWorkApi(params, "getall").then((res) => {
        if (res.data.success) {
