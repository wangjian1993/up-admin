 ...
 * @LastEditTime: 2023-04-11 15:42:03
 * @LastEditors: max
 * @Description: 
 * @FilePath: /up-admin/src/pages/home/lamp/user/index.vue
-->
<template>
  <div>
        ...
        <a-form layout="horizontal" :form="searchForm">
          <div :class="advanced ? null : 'fold'">
            <a-row>
              ...
              <a-col :md="6" :sm="24">
                <a-form-item label="员工姓名" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18, offset: 1 }">
                  <a-input style="width: 200px" allowClear placeholder="请输入员工姓名" v-decorator="['username']" />
                </a-form-item>
              </a-col>
              <!-- <a-col :md="6" :sm="24">
