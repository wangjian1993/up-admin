 ...
 * @LastEditTime: 2023-04-04 09:49:00
 * @LastEditors: max
 * @Description: 
 * @FilePath: /up-admin/src/pages/home/lamp/register/index.vue
-->
<template>
  <div>
    <a-spin tip="导出中..." :spinning="isExportLod">
      ...
      <Borrowed v-if="isBorrowed" :editData="editData" :isOut="true" @closeModal="closeModal" @success="searchBtn" />
...
export default {
  mixins: [PublicVar],
  components: { useForm, HistoryList, Borrowed, ImportExcel },
  data() {
    return {
      scrollY: "",
      advanced: true,
